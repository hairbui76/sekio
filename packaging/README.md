...
tag is pushed. As of v0.4.0 that is exactly three installers, all x86_64:
...
were removed after v0.4.0: the three native installers are the supported paths,
...
```sh
sudo apt install ./sekio_0.4.0-1_amd64.deb     # Debian/Ubuntu
sudo dnf install ./sekio-0.4.0-1.x86_64.rpm    # Fedora/RHEL/openSUSE
```
