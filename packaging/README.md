...
tag is pushed. As of v0.18.0 that is exactly three installers, all x86_64:
...
```sh
sudo apt install ./sekio_0.18.0-1_amd64.deb     # Debian/Ubuntu
sudo dnf install ./sekio-0.18.0-1.x86_64.rpm    # Fedora/RHEL/openSUSE
```
...
```powershell
msiexec /i sekio-0.18.0-x86_64-pc-windows-msvc.msi
msiexec /i sekio-0.18.0-x86_64-pc-windows-msvc.msi /quiet    # unattended
msiexec /x sekio-0.18.0-x86_64-pc-windows-msvc.msi           # uninstall
```
