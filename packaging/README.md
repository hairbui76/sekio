...
tag is pushed. As of v0.11.0 that is exactly three installers, all x86_64:
...
```sh
sudo apt install ./sekio_0.11.0-1_amd64.deb     # Debian/Ubuntu
sudo dnf install ./sekio-0.11.0-1.x86_64.rpm    # Fedora/RHEL/openSUSE
```
