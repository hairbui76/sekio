...
tag is pushed. As of v0.17.0 that is exactly three installers, all x86_64:
...
```powershell
msiexec /i sekio-0.17.0-x86_64-pc-windows-msvc.msi
msiexec /i sekio-0.17.0-x86_64-pc-windows-msvc.msi /quiet    # unattended
msiexec /x sekio-0.17.0-x86_64-pc-windows-msvc.msi           # uninstall
```
